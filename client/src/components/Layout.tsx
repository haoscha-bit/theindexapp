...
const INDEX_LOGO_GLOW = `${import.meta.env.BASE_URL}assets/The_Index_Logo.webp`;
const BEEPER_ICON = `${import.meta.env.BASE_URL}assets/prescript-beeper.png`;
const DONSCREAM_URL = `${import.meta.env.BASE_URL}assets/DONSCREAM.mp3`;
